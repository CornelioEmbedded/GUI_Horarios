...
parse = ParseSubjects()
parse.from_excel_to_csv(r"C:\Users\DELL\Downloads\IMTC2.xlsx", "clase_ordinaria")
classes_dict = parse.get_dict_from_csv(pd.read_csv(r'generated\csv_clase_ordinaria.csv'))
